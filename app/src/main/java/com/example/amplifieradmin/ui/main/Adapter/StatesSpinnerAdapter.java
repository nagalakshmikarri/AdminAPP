...
import com.example.amplifieradmin.data.model.StatesData;
...
public class StatesSpinnerAdapter extends ArrayAdapter<StatesData> {
    ...
    private List<StatesData> items;
    private OnClickListener listener;

    public StatesSpinnerAdapter(Context context, boolean hint, List<StatesData> items,
...
//                holder.tilTitle.setHint(items.get(0).getName());
    ...
    public List<StatesData> getList() {
        return items;
    }
